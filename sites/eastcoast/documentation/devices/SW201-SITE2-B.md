...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | default | 172.20.20.21/24 | - |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet50 | SERVER_site2-server1_Ethernet1 | access | 230 | - | - | - |
...
| --------- | ----------- | ------------- | ---------- | --- | --- | -------- | ------ | ------- |
| Ethernet47 | P2P_SW101-SITE1-B_Ethernet47 | - | 10.101.50.5/31 | default | 1500 | False | - | - |
| Ethernet56/1 | P2P_SW203-SITE2-P_Ethernet53/1 | - | 10.11.50.12/31 | default | 1500 | False | - | - |
...
interface Ethernet47
   description P2P_SW101-SITE1-B_Ethernet47
   no shutdown
   mtu 1500
   no switchport
   ip address 10.101.50.5/31
...
interface Ethernet50
   description SERVER_site2-server1_Ethernet1
   no shutdown
...
interface Ethernet56/1
   description P2P_SW203-SITE2-P_Ethernet53/1
   no shutdown
   mtu 1500
   no switchport
   ip address 10.11.50.12/31
   isis enable EVPN_UNDERLAY
   isis circuit-type level-2
   isis metric 50
   isis network point-to-point
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 10.101.30.3/32 |
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 10.101.40.3/32 |
| Loopback10 | INBAND_MGMT | Production | 10.0.10.21/32 |
...
| Vlan230 | VideoTrafficBlue | default | - | - |
...
!
interface Vxlan1
   description SW201-SITE2-B_VTEP
...
| Net-ID | 49.0001.0101.0103.0003.00 |
| Type | level-2 |
...
router isis EVPN_UNDERLAY
   net 49.0001.0101.0103.0003.00
   router-id ipv4 10.101.30.3
   is-type level-2
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 212 | 10.101.30.3:10212 | 10212:10212 | - | - | learned |
| 213 | 10.101.30.3:10213 | 10213:10213 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | Graceful Restart |
| --- | ------------------- | ------------ | ---------------- |
| Production | 10.101.30.3:11111 | connected | - |
...
router bgp 65201
   ...
   !
   vlan 212
      rd 10.101.30.3:10212
      route-target both 10212:10212
      redistribute learned
   !
   vlan 213
      rd 10.101.30.3:10213
...
| ---- | --------------- | ---------- | -------------- | ----------------- | -------------------------- | ----------------------- | ---------------------- | ------------------- | ------- |
| 212 | True | 10.101.30.3 | - | - | - | - | - | - | - |
| 213 | True | 10.101.30.3 | - | - | - | - | - | - | - |
...
ip igmp snooping vlan 212 querier address 10.101.30.3
ip igmp snooping vlan 213 querier
ip igmp snooping vlan 213 querier address 10.101.30.3
