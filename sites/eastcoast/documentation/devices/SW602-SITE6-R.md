...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | default | 172.20.20.62/24 | - |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet50 | SERVER_site6-server1_Ethernet2 | access | 631 | - | - | - |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet47 | P2P_SW102-SITE1-R_Ethernet41 | - | 10.102.50.11/31 | default | 1500 | False | - | - |
| Ethernet56/1 | P2P_SW603-SITE6-P_Ethernet54/1 | - | 10.11.50.22/31 | default | 1500 | False | - | - |
...
interface Ethernet47
   description P2P_SW102-SITE1-R_Ethernet41
   no shutdown
   mtu 1500
   no switchport
   ip address 10.102.50.11/31
...
interface Ethernet50
   description SERVER_site6-server1_Ethernet2
   no shutdown
...
interface Ethernet56/1
   description P2P_SW603-SITE6-P_Ethernet54/1
   no shutdown
   mtu 1500
   no switchport
   ip address 10.11.50.22/31
   isis enable EVPN_UNDERLAY
   isis circuit-type level-2
   isis metric 50
   isis network point-to-point
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 10.102.30.6/32 |
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 10.102.40.6/32 |
| Loopback10 | INBAND_MGMT | Production | 10.0.10.62/32 |
...
!
interface Vxlan1
   description SW602-SITE6-R_VTEP
...
Virtual Router MAC Address: 00:1c:73:00:dc:62

#### Virtual Router MAC Address Device Configuration

```eos
!
ip virtual-router mac-address 00:1c:73:00:dc:62
```
...
| Net-ID | 49.0001.0101.0203.0006.00 |
| Type | level-2 |
| Router-ID | 10.102.30.6 |
...
router isis EVPN_UNDERLAY
   net 49.0001.0101.0203.0006.00
   router-id ipv4 10.102.30.6
   is-type level-2
