...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | default | 172.20.20.52/24 | - |
...
| --------- | ----------- | ------------- | ---------- | --- | --- | -------- | ------ | ------- |
| Ethernet39 | P2P_SW402-SITE4-R_Ethernet47 | - | 10.102.50.9/31 | default | 1500 | False | - | - |
...
interface Ethernet39
   description P2P_SW402-SITE4-R_Ethernet47
   no shutdown
   mtu 1500
   no switchport
   ip address 10.102.50.9/31
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 10.102.30.5/32 |
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 10.102.40.5/32 |
| Loopback10 | INBAND_MGMT | Production | 10.0.10.52/32 |
...
| Vlan531 | VideoTrafficRed | default | - | - |
| Vlan536 | SRTTrafficRed | Production | - | False |
...
| Vlan531 | default | 10.5.31.1/24 | - | - | - | - |
| Vlan536 | Production | 10.5.36.1/24 | - | - | - | - |

##### ISIS

| Interface | ISIS Instance | ISIS BFD | ISIS Metric | Mode | ISIS Authentication Mode |
| --------- | ------------- | -------- | ----------- | ---- | ------------------------ |
| Vlan531 | EVPN_UNDERLAY | - | - | - | - |
...
!
interface Vxlan1
   description SW502-SITE5-R_VTEP
...
Virtual Router MAC Address: 00:1c:73:00:dc:24

#### Virtual Router MAC Address Device Configuration

```eos
!
ip virtual-router mac-address 00:1c:73:00:dc:24
```
...
| Net-ID | 49.0001.0101.0203.0005.00 |
| Type | level-2 |
| Router-ID | 10.102.30.5 |
...
router isis EVPN_UNDERLAY
   net 49.0001.0101.0203.0005.00
   router-id ipv4 10.102.30.5
   is-type level-2
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 6 | 10.102.30.5:10006 | 10006:10006 | - | - | learned |
| 110 | 10.102.30.5:10110 | 10110:10110 | - | - | learned |
| 512 | 10.102.30.5:10512 | 10512:10512 | - | - | learned |
| 513 | 10.102.30.5:10513 | 10513:10513 | - | - | learned |
| 520 | 10.102.30.5:10520 | 10520:10520 | - | - | learned |
| 536 | 10.102.30.5:10536 | 10536:10536 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | Graceful Restart |
| --- | ------------------- | ------------ | ---------------- |
| Production | 10.102.30.5:11111 | connected | - |
...
router bgp 65502
   ...
   !
   vlan 6
      rd 10.102.30.5:10006
      route-target both 10006:10006
      redistribute learned
   !
   vlan 110
      rd 10.102.30.5:10110
      route-target both 10110:10110
      redistribute learned
   !
   vlan 512
      rd 10.102.30.5:10512
      route-target both 10512:10512
      redistribute learned
   !
   vlan 513
      rd 10.102.30.5:10513
      route-target both 10513:10513
      redistribute learned
   !
   vlan 520
      rd 10.102.30.5:10520
      route-target both 10520:10520
      redistribute learned
   !
   vlan 536
      rd 10.102.30.5:10536
      route-target both 10536:10536
      redistribute learned
   !
   address-family evpn
...
| ---- | --------------- | ---------- | -------------- | ----------------- | -------------------------- | ----------------------- | ---------------------- | ------------------- | ------- |
| 512 | True | 10.102.30.5 | - | - | - | - | - | - | - |
| 513 | True | 10.102.30.5 | - | - | - | - | - | - | - |
| 536 | True | 10.102.30.5 | - | - | - | - | - | - | - |
...
ip igmp snooping vlan 512 querier address 10.102.30.5
ip igmp snooping vlan 513 querier
ip igmp snooping vlan 513 querier address 10.102.30.5
ip igmp snooping vlan 531
ip igmp snooping vlan 536 querier
ip igmp snooping vlan 536 querier address 10.102.30.5
```
