...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | default | 172.20.20.42/24 | - |
...
| --------- | ----------- | ------------- | ---------- | --- | --- | -------- | ------ | ------- |
| Ethernet45 | P2P_SW102-SITE1-R_Ethernet43 | - | 10.102.50.7/31 | default | 1500 | False | - | - |
| Ethernet47 | P2P_SW502-SITE5-R_Ethernet39 | - | 10.102.50.8/31 | default | 1500 | False | - | - |
...
interface Ethernet45
   description P2P_SW102-SITE1-R_Ethernet43
   no shutdown
   mtu 1500
   no switchport
   ip address 10.102.50.7/31
...
interface Ethernet47
   description P2P_SW502-SITE5-R_Ethernet39
   no shutdown
   mtu 1500
   no switchport
   ip address 10.102.50.8/31
   pim ipv4 sparse-mode
   isis enable EVPN_UNDERLAY
   isis circuit-type level-2
   isis metric 50
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 10.102.30.4/32 |
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 10.102.40.4/32 |
| Loopback10 | INBAND_MGMT | Production | 10.0.10.42/32 |
...
!
interface Vxlan1
   description SW402-SITE4-R_VTEP
...
| Net-ID | 49.0001.0101.0203.0004.00 |
| Type | level-2 |
| Router-ID | 10.102.30.4 |
...
router isis EVPN_UNDERLAY
   net 49.0001.0101.0203.0004.00
   router-id ipv4 10.102.30.4
   is-type level-2
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 6 | 10.102.30.4:10006 | 10006:10006 | - | - | learned |
| 413 | 10.102.30.4:10413 | 10413:10413 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | Graceful Restart |
| --- | ------------------- | ------------ | ---------------- |
| Production | 10.102.30.4:11111 | connected | - |
...
router bgp 65402
   ...
   !
   vlan 6
      rd 10.102.30.4:10006
      route-target both 10006:10006
      redistribute learned
   !
   vlan 413
      rd 10.102.30.4:10413
...
ip igmp snooping vlan 413 querier address 10.102.30.4
```
